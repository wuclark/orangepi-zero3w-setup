...
`openbox`, `xfce`, `i3`, `icewm`, `fluxbox`, `mate`, `plasma`, `lxqt`, `lxde`, `budgie`, `cinnamon`, `gnome`, `gnome-flashback`, `compiz`, and `enlightenment-x11` use X11. `sway`, `labwc`, and `enlightenment-wayland` use the
