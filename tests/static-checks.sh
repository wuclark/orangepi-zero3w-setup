...
grep -q 'fullbackup' "$REPO_ROOT/Makefile"
grep -q 'fullrestore' "$REPO_ROOT/Makefile"
grep -q 'BUNDLE_COMPRESS ?= gzip' "$REPO_ROOT/Makefile"
grep -q 'INCLUDE_SENSITIVE' "$REPO_ROOT/scripts/create-offline-bundle.sh"
grep -q 'firstboot' "$REPO_ROOT/scripts/create-offline-bundle.sh"
grep -q 'SHA256SUMS' "$REPO_ROOT/scripts/restore-offline-bundle.sh"
grep -q 'repo.bundle' "$REPO_ROOT/scripts/create-offline-bundle.sh"
grep -q 'repo.bundle' "$REPO_ROOT/scripts/restore-offline-bundle.sh"
