...
.PHONY: help version docker-toolchain kernel-source extract preset preloaded firstboot image newsd summary show-unredacted validate test tests clean \
	...
	switch-openbox switch-xfce switch-i3 switch-icewm switch-fluxbox switch-mate switch-plasma switch-lxqt switch-lxde switch-budgie switch-cinnamon switch-gnome switch-gnome-flashback switch-compiz switch-sway switch-labwc \
...
help:
	@printf '%s\n' \
		...
		'make board-manifest                   Show the recorded board replay manifest' \
		'make board-replay                     Dry-run replay of the board manifest' \
		'make board-replay-execute             Execute the board manifest replay' \
		...
		'make board-vpu-decode-speed             Time Cedar vs software decode fps' \
...
board-manifest:
	./scripts/board-manifest.sh

board-replay:
	./scripts/board-replay.sh

board-replay-execute:
	./scripts/board-replay.sh --execute
...
desktop-gnome: DESKTOP_PROFILE := gnome
desktop-gnome: desktop
desktop-gnome-flashback: DESKTOP_PROFILE := gnome-flashback
desktop-gnome-flashback: desktop
desktop-compiz: DESKTOP_PROFILE := compiz
desktop-compiz: desktop
...
switch-mate: DESKTOP_PROFILE := mate
...
switch-lxde: DESKTOP_PROFILE := lxde
...
switch-gnome: DESKTOP_PROFILE := gnome
switch-gnome: desktop-switch
switch-gnome-flashback: DESKTOP_PROFILE := gnome-flashback
switch-gnome-flashback: desktop-switch
switch-compiz: DESKTOP_PROFILE := compiz
switch-compiz: desktop-switch
...
board-vpu-decode-speed:
	sudo ./scripts/test-vpu-decode-speed.sh --output /var/log/orangepi-zero3w-setup/vpu-decode-speed.txt
