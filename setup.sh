...
Usage:
  ...
  sudo ./setup.sh desktop --profile PROFILE [options]
   ...
   sudo ./setup.sh touch-rightclick [--device-name NAME] [--backend uinput|xtest|auto] [--gesture hold|tap-hold] [--hold-ms MS] [--tap-ms MS] [--move-units N] [--move-fraction F] [--debug] [--update|--no-start|--uninstall]
